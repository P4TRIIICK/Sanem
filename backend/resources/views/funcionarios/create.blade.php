...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            ...
            <form action="{{ route('web.funcionarios.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="tel" class="form-control" id="telefone" name="telefone" placeholder="(XX) XXXXX-XXXX" value="{{ old('telefone') }}">
                    </div>
                </div>
                 ...
                 <div class="row align-items-center">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select" id="role" name="role" required>
                            ...
                            <option value="Consultor" @if(old('role') == 'Consultor') selected @endif>Consultor</option>
                            <option value="Administrador" @if(old('role') == 'Administrador') selected @endif>Administrador</option>
                        </select>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="salario" class="form-label">Salário (R$) (Opcional)</label>
                        <input type="number" step="0.01" class="form-control" id="salario" name="salario" placeholder="Ex: 3500.50" value="{{ old('salario') }}">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="data_contratacao" class="form-label">Data de Contratação</label>
                        <input type="date" class="form-control" id="data_contratacao" name="data_contratacao" value="{{ old('data_contratacao', date('Y-m-d')) }}" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
